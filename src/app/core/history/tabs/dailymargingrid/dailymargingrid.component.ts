...
@Component({
  selector: 'app-dailymargingrid',
  templateUrl: './dailymargingrid.component.html',
  styleUrls: ['./dailymargingrid.component.scss']
})
export class DailymargingridComponent implements OnInit {
  @Input() auditData!: any[];
