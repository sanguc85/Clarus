...
@Component({
  selector: 'app-fileloadgrid',
  templateUrl: './fileloadgrid.component.html',
  styleUrls: ['./fileloadgrid.component.scss']
})
export class FileloadgridComponent implements OnInit {
  @Input() auditData!: any[];
