...
@Component({
  selector: 'app-collateralmovementgrid',
  templateUrl: './collateralmovementgrid.component.html',
  styleUrls: ['./collateralmovementgrid.component.scss']
})
export class CollateralmovementgridComponent implements OnInit {
  @Input() auditData!: any[];
