...
@Component({
  selector: 'app-monthlyinterestgrid',
  templateUrl: './monthlyinterestgrid.component.html',
  styleUrls: ['./monthlyinterestgrid.component.scss']
})
export class MonthlyinterestgridComponent implements OnInit {
  @Input() auditData!: any[];
