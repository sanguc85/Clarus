...
@Component({
  selector: 'app-collateralbalancegrid',
  templateUrl: './collateralbalancegrid.component.html',
  styleUrls: ['./collateralbalancegrid.component.scss']
})

export class CollateralbalancegridComponent implements OnInit {
  @Input() auditData!: any[];
