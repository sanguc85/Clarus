...
@Component({
  selector: 'app-useraccessgrid',
  templateUrl: './useraccessgrid.component.html',
  styleUrls: ['./useraccessgrid.component.scss']
})
export class UseraccessgridComponent implements OnInit {
  @Input() auditData!: any[];
