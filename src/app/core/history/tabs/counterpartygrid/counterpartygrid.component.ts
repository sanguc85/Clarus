...
@Component({
  selector: 'app-counterpartygrid',
  templateUrl: './counterpartygrid.component.html',
  styleUrls: ['./counterpartygrid.component.scss']
})
export class CounterpartygridComponent implements OnInit {
  @Input() auditData!: any[];
